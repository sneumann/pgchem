...
OBFormat.TypeID = new_instancemethod(_openbabel.OBFormat_TypeID,None,OBFormat)
...
OBMol.BeginAtoms = new_instancemethod(_openbabel.OBMol_BeginAtoms,None,OBMol)
OBMol.EndAtoms = new_instancemethod(_openbabel.OBMol_EndAtoms,None,OBMol)
OBMol.BeginBonds = new_instancemethod(_openbabel.OBMol_BeginBonds,None,OBMol)
OBMol.EndBonds = new_instancemethod(_openbabel.OBMol_EndBonds,None,OBMol)
OBMol.BeginResidues = new_instancemethod(_openbabel.OBMol_BeginResidues,None,OBMol)
OBMol.EndResidues = new_instancemethod(_openbabel.OBMol_EndResidues,None,OBMol)
...
AliasData.SetExpandedAtoms = new_instancemethod(_openbabel.AliasData_SetExpandedAtoms,None,AliasData)
AliasData.GetExpandedAtoms = new_instancemethod(_openbabel.AliasData_GetExpandedAtoms,None,AliasData)
...
OBFingerprint.TypeID = new_instancemethod(_openbabel.OBFingerprint_TypeID,None,OBFingerprint)
...
class FptIndex(object):
    ...
    def __init__(self): 
        _openbabel.FptIndex_swiginit(self,_openbabel.new_FptIndex())
    __swig_destroy__ = _openbabel.delete_FptIndex
FptIndex.Read = new_instancemethod(_openbabel.FptIndex_Read,None,FptIndex)
FptIndex.CheckFP = new_instancemethod(_openbabel.FptIndex_CheckFP,None,FptIndex)
...
OBDescriptor.TypeID = new_instancemethod(_openbabel.OBDescriptor_TypeID,None,OBDescriptor)
...
OBForceField.TypeID = new_instancemethod(_openbabel.OBForceField_TypeID,None,OBForceField)
...
OBOp.TypeID = new_instancemethod(_openbabel.OBOp_TypeID,None,OBOp)
