...
#if !(!defined(MAKE_SHARED_LIBRARY))
DLLEXPORT void cm_tweak_molfile(char *buf);
DLLEXPORT void cm_fg_codes(char *buf);
DLLEXPORT void cm_molstat_sql_substruct(char *buf);
DLLEXPORT void cm_molstat_sql_exact(char *buf);
DLLEXPORT void cm_molstat(char *buf);
DLLEXPORT void cm_molstat_X(char *buf);
